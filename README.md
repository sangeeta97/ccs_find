...
CCSfind can handle both chromatographically separated isomers and IM separation of isomeric ions (e.g., “protomers” or conformers of the same ion species) with simple user control over the output for new database entries in SQL format. The peak picking code has been obtained from tidyms package (https://github.com/griquelme/tidyms) based on the Centwave algorithm. 
